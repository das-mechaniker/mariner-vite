...
export interface ApiAgentAgent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'AI agents for Project Mariner'
    displayName: 'Agent'
    pluralName: 'agents'
    singularName: 'agent'
  }
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::agent.agent'> &
      Schema.Attribute.Private
    modelId: Schema.Attribute.String
...
export interface ApiCapabilityCapability extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'AI capabilities for agents'
  ...
  attributes: {
    ...
    icon: Schema.Attribute.String
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::capability.capability'> &
      Schema.Attribute.Private
    name: Schema.Attribute.String & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
...
export interface ApiDocumentationArticleDocumentationArticle extends Struct.CollectionTypeSchema {
...
export interface ApiDocumentationCategoryDocumentationCategory extends Struct.CollectionTypeSchema {
...
export interface ApiPromptPrompt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Prompt library for AI interactions'
    displayName: 'Prompt'
    pluralName: 'prompts'
    singularName: 'prompt'
  }
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::prompt.prompt'> &
      Schema.Attribute.Private
    promptText: Schema.Attribute.Text & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
...
export interface ApiResearchLabResearchLab extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::research-lab.research-lab'> &
      Schema.Attribute.Private
    name: Schema.Attribute.String & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Custom user model for Project Mariner'
    displayName: 'User'
    pluralName: 'users'
    singularName: 'user'
  }
